...
export const Header = () => {
  return (
    <header className=" bg-white backdrop-blur-xl text-black sticky top-0 z-10 items-center place-content-center self-center place-items-center">
      <nav
        aria-label="Global"
        className="mx-auto flex max-w-7xl items-center justify-between pr-6 py-2 lg:px-0 lg:py-1"
      >
